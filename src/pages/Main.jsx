...
export const Main = () => {
  ...
  const [modalVaultChange, setModalVaultChange] = useState(false)
  ...
  return (
    <>
      <AnimatePresence>
        ...
        >
          <div className='w-[350px]'>
            <UserCard
              openModalWithdrawTokens={() => {setPanel(false); setModalWithdrawTokens(true)}} 
      ...
      <AnimatePresence>
        {modalVaultChange && <ModalVaultChange onCloseModal={() => setModalVaultChange(false)}/>}
      </AnimatePresence>
      ...
      <div className={`${styles.globalPaddings} app lg:max-w-[1920px] lg:m-[auto]`}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={windowWidth < 1100 ? 0 : 3}>
            ...
            >
              <UserCard 
                openModalWithdrawTokens={() => setModalVaultChange(true)}
                openModal={() => {setPanel(false); setModalDisconnect(true)} }
